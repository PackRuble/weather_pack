...
Map<String, WeatherLanguage> get codeAndLangMatching =>
    <String, WeatherLanguage>{
      ...
      WeatherLanguage.portugueseBrazilian.code:
          WeatherLanguage.portugueseBrazilian,
      ...
      WeatherLanguage.chineseTraditional.code:
          WeatherLanguage.chineseTraditional,
